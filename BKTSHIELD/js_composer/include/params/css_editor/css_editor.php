	...
	class WPBakeryVisualComposerCssEditor {
		...
		function render() {
			...
			$output .= '<div class="vc_col-xs-5 vc_settings">'
			           . '    <label>' . __( 'Border', 'blackfyre' ) . '</label> '
			           ...
			           . '    <label>' . __( 'Background', 'blackfyre' ) . '</label>'
			           ...
			           . '    <label>' . __( 'Box controls', 'blackfyre' ) . '</label>'
			           . '    <label class="vc_checkbox"><input type="checkbox" name="simply" class="vc_simplify" value=""> ' . __( 'Simplify controls', 'blackfyre' ) . '</label>'
			           . '</div>';
		...
		function getBackgroundImageControl() {
			return apply_filters( 'vc_css_editor_background_image_control', '<ul class="vc_image">'
			                                                                . '</ul>'
			                                                                . '<a href="#" class="vc_add-image">' . __( 'Add image', 'blackfyre' ) . '</a>' );
		}
		...
		function getBorderStyleOptions() {
			$output = '<option value="">' . __( 'Theme defaults', 'blackfyre' ) . '</option>';
			...
			foreach ( $styles as $style ) {
				$output .= '<option value="' . $style . '">' . __( ucfirst( $style ), 'blackfyre' ) . '</option>';
			}
		...
		protected function layerControls( $name, $prefix = '' ) {
			$output = '<label>' . __( $name, 'blackfyre' ) . '</label>';
