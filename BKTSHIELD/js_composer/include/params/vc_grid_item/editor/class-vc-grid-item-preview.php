...
Class Vc_Grid_Item_Preview {
	...
	public function mockingPost() {
		...
		$post->post_title = __( 'Post title', 'blackfyre' );
		$post->post_content = __( 'The WordPress Excerpt is an optional summary or description of a post; in short, a post summary.', 'blackfyre' );
		$post->post_excerpt = __( 'The WordPress Excerpt is an optional summary or description of a post; in short, a post summary.', 'blackfyre' );
		$GLOBALS['post'] = $post;
