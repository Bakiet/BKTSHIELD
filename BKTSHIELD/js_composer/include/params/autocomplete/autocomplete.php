...
/*	vc_map(
	    array(
			'name'        => __( 'Check autocomplete', 'blackfyre' ),
			'base'        => 'vc_some_autocomplete',
			'icon'        => 'icon-wpb-empty_space',
			'category'    => __( 'New Elements', 'blackfyre' ),
			'description' => __( 'Something cool and best', 'blackfyre' ),
			'params'      => array(
				array(
					'type'        => 'autocomplete',
					'heading'     => __( 'Type a for example', 'blackfyre' ),
					'param_name'  => 'ids',
					'settings'    => array(
						'multiple' => true,
						'sortable' => true,
