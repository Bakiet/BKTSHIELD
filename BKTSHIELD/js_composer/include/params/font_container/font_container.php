 ...
 *            ),
 *        ),
 *        // 'description' => __( '', 'blackfyre' ), // description for field group
 *    ),
		...
		if ( ! empty( $fields ) ) {
			if ( isset( $fields['tag'] ) ) {
                ...
                <div class="vc_row-fluid vc_column">
                    <div class="wpb_element_label">' . __( 'Element tag', 'blackfyre' ) . '</div>
				...
				foreach ( $tags as $tag ) {
					$data['tag'] .= '<option value="' . $tag . '" class="' . $tag . '" ' . ( $values['tag'] == $tag ? 'selected="selected"' : '' ) . '>' . __( $tag, 'blackfyre' ) . '</option>';
				}
				$data['tag'] .= '
                        </select>
                    </div>';
			...
			if ( isset( $fields['font_size'] ) ) {
				$data['font_size'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="wpb_element_label">' . __( 'Font size', 'blackfyre' ) . '</div>
			...
			if ( isset( $fields['text_align'] ) ) {
				$data['text_align'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="wpb_element_label">' . __( 'Text align', 'blackfyre' ) . '</div>
                    <div class="vc_font_container_form_field-text_align-container">
                        <select class="vc_font_container_form_field-text_align-select">
                            <option value="left" class="left" ' . ( $values['text_align'] == 'left' ? 'selected="selected"' : '' ) . '>' . __( 'left', 'blackfyre' ) . '</option>
                            <option value="right" class="right" ' . ( $values['text_align'] == 'right' ? 'selected="selected"' : '' ) . '>' . __( 'right', 'blackfyre' ) . '</option>
                            <option value="center" class="center" ' . ( $values['text_align'] == 'center' ? 'selected="selected"' : '' ) . '>' . __( 'center', 'blackfyre' ) . '</option>
                            <option value="justify" class="justify" ' . ( $values['text_align'] == 'justify' ? 'selected="selected"' : '' ) . '>' . __( 'justify', 'blackfyre' ) . '</option>
                        </select>
                    </div>';
			...
			if ( isset( $fields['line_height'] ) ) {
				$data['line_height'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="wpb_element_label">' . __( 'Line height', 'blackfyre' ) . '</div>
			...
			if ( isset( $fields['color'] ) ) {
				$data['color'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="wpb_element_label">' . __( 'Text color', 'blackfyre' ) . '</div>
			...
			if ( isset( $fields['font_family'] ) ) {
				$data['font_family'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="wpb_element_label">' . __( 'Font Family', 'blackfyre' ) . '</div>
				...
				foreach ( $fonts as $font_name => $font_data ) {
					$data['font_family'] .= '<option value="' . $font_name . '" class="' . vc_build_safe_css_class( $font_name ) . '" ' . ( strtolower( $values['font_family'] ) == strtolower( $font_name ) ? 'selected="selected"' : '' ) . ' data[font_family]="' . urlencode( $font_data ) . '">' . __( $font_name, 'blackfyre' ) . '</option>';
				}
				$data['font_family'] .= '
                        </select>
                    </div>';
			...
			if ( isset( $fields['font_style'] ) ) {
				$data['font_style'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="wpb_element_label">' . __( 'Font style', 'blackfyre' ) . '</div>
                    <div class="vc_font_container_form_field-font_style-container">
                        <label>
                            <input type="checkbox" class="vc_font_container_form_field-font_style-checkbox italic" value="italic" ' . ( $values['font_style_italic'] == "1" ? 'checked="checked"' : '' ) . '><span class="vc_font_container_form_field-font_style-label italic">' . __( 'italic', 'blackfyre' ) . '</span>
                         </label>
                        <br />
                        <label>
                            <input type="checkbox" class="vc_font_container_form_field-font_style-checkbox bold" value="bold" ' . ( $values['font_style_bold'] == "1" ? 'checked="checked"' : '' ) . '><span class="vc_font_container_form_field-font_style-label bold">' . __( 'bold', 'blackfyre' ) . '</span>
                        </label>
                    </div>';
