...
class Vc_Vendor_Layerslider implements Vc_Vendor_Interface {
  ...
  "
			...
			if ( ! empty( $ls ) ) {
				...
				$layer_sliders[ __( 'No sliders found', 'blackfyre' ) ] = 0;
			}
		} else {
		...
		vc_map( array(
			'base' => 'layerslider_vc',
			'name' => __( 'Layer Slider', 'blackfyre' ),
			'icon' => 'icon-wpb-layerslider',
			'category' => __( 'Content', 'blackfyre' ),
			'description' => __( 'Place LayerSlider', 'blackfyre' ),
			'params' => array(
				array(
					'type' => 'textfield',
				...
				array(
					'type' => 'dropdown',
					'heading' => __( 'LayerSlider ID', 'blackfyre' ),
					'param_name' => 'id',
					'admin_label' => true,
					'value' => $layer_sliders,
					'description' => __( 'Select your LayerSlider.', 'blackfyre' )
				),
				array(
					'type' => 'textfield',
