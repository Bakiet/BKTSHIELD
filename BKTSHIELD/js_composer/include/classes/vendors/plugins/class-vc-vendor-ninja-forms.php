...
Class Vc_Vendor_NinjaForms implements Vc_Vendor_Interface {
	...
	public function mapNinjaForms( $ninja_forms = array() ) {
		...
		vc_map( array(
				...
				'name' => __( 'Ninja Forms', 'blackfyre' ),
				'icon' => 'icon-wpb-ninjaforms',
				'category' => __( 'Content', 'blackfyre' ),
				'description' => __( 'Place Ninja Form', 'blackfyre' ),
				'params' => array(
					array(
						'type' => 'dropdown',
						'heading' => __( 'Select ninja form', 'blackfyre' ),
						'param_name' => 'id',
						'value' => $ninja_forms,
						'description' => __( 'Choose previously created ninja form from the drop down list.', 'blackfyre' ),
					),
				),
			)
		);
