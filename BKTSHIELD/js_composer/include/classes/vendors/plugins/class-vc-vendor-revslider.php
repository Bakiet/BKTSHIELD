...
class Vc_Vendor_Revslider implements Vc_Vendor_Interface {
	...
	public function buildShortcode() {
		if ( class_exists( 'RevSlider' ) ) {
			...
			if ( $arrSliders ) {
				...
				$revsliders[ __( 'No sliders found', 'blackfyre' ) ] = 0;
			}
	...
	public function mapShortcode( $revsliders = array() ) {
		vc_map( array(
			'base' => 'rev_slider_vc',
			'name' => __( 'Revolution Slider', 'blackfyre' ),
			'icon' => 'icon-wpb-revslider',
			'category' => __( 'Content', 'blackfyre' ),
			'description' => __( 'Place Revolution slider', 'blackfyre' ),
			"params" => array(
				array(
					'type' => 'textfield',
				...
				array(
					'type' => 'dropdown',
					'heading' => __( 'Revolution Slider', 'blackfyre' ),
					'param_name' => 'alias',
					'admin_label' => true,
					'value' => $revsliders,
					'description' => __( 'Select your Revolution Slider.', 'blackfyre' )
				),
				array(
					'type' => 'textfield',
