...
class WPBakeryShortCode_VC_Column extends WPBakeryShortCode {
	...
	public function getColumnControls( $controls, $extended_css = '' ) {
		...
		if ( $extended_css == 'bottom-controls' ) {
			$control_title = __( 'Append to this column', 'blackfyre' );
		} else {
			$control_title = __( 'Prepend to this column', 'blackfyre' );
		}
		...
		$controls_edit = ' <a class="vc_control column_edit vc_column-edit"  data-vc-control="edit" href="#" title="' . __( 'Edit this column', 'blackfyre' ) . '"><i class="vc_icon"></i></a>';
		$controls_delete = ' <a class="vc_control column_delete vc_column-delete" data-vc-control="delete"  href="#" title="' . __( 'Delete this column', 'blackfyre' ) . '"><i class="vc_icon"></i></a>';
