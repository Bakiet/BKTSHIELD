<?php
define( 'TAB_TITLE', __( 'Tab', 'blackfyre' ) );
...
class WPBakeryShortCode_VC_Tab extends WPBakeryShortCode_VC_Column {
	...
	public function getColumnControls( $controls, $extended_css = '' ) {
		...
		if ( $extended_css == 'bottom-controls' ) $control_title = sprintf( __( 'Append to this %s', 'blackfyre' ), strtolower( $this->settings( 'name' ) ) );
		else $control_title = sprintf( __( 'Prepend to this %s', 'blackfyre' ), strtolower( $this->settings( 'name' ) ) );

		$controls_add = ' <a class="vc_control column_add" href="#" title="' . $control_title . '"><i class="vc_icon"></i></a>';
		$controls_edit = ' <a class="vc_control column_edit" href="#" title="' . sprintf( __( 'Edit this %s', 'blackfyre' ), strtolower( $this->settings( 'name' ) ) ) . '"><i class="vc_icon"></i></a>';
		$controls_clone = '<a class="vc_control column_clone" href="#" title="' . sprintf( __( 'Clone this %s', 'blackfyre' ), strtolower( $this->settings( 'name' ) ) ) . '"><i class="vc_icon"></i></a>';

		$controls_delete = '<a class="vc_control column_delete" href="#" title="' . sprintf( __( 'Delete this %s', 'blackfyre' ), strtolower( $this->settings( 'name' ) ) ) . '"><i class="vc_icon"></i></a>';
