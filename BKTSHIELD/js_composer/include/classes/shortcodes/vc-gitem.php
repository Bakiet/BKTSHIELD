...
class WPBakeryShortCode_VC_Gitem extends WPBakeryShortCodesContainer {
	...
	public function getControls( $controls ) {
		...
		$controls_edit = ' <a class="vc_control-btn vc_control-btn-edit" href="#" title="' . __( 'Edit this grid item', 'blackfyre' ) . '" data-vc-control="edit"><i class="vc_icon"></i></a>';
		$controls_delete = ' <a class="vc_control-btn vc_control-btn-delete" href="#" title="' . __( 'Delete this grid item ', 'blackfyre' ) . '" data-vc-control="delete"><i class="vc_icon"></i></a>';
