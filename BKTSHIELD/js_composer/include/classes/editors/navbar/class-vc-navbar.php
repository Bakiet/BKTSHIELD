...
Class Vc_Navbar implements Vc_Render {
	...
	public function getLogo() {
		$output = '<a id="vc_logo" class="vc_navbar-brand" title="' . __( 'Visual Composer', 'blackfyre' )
		          . '" href="' . esc_attr( $this->brand_url ) . '" target="_blank">'
		          . __( 'Visual Composer', 'blackfyre' ) . '</a>';
	...
	public function getControlCustomCss() {
		return '<li class="vc_pull-right"><a id="vc_post-settings-button" class="vc_icon-btn vc_post-settings" title="'
		       . __( 'Page settings', 'blackfyre' ) . '">'
		       . '<span id="vc_post-css-badge" class="vc_badge vc_badge-custom-css" style="display: none;">' . __( 'CSS', 'blackfyre' ) . '</span></a>'
		       . '</li>';
	}
