...
class Vc_Base {
	...
	public function registerAdminJavascript() {
		...
		wp_localize_script( 'wpb_js_composer_js_view', 'i18nLocale', apply_filters( 'vc_i18n_locale_composer_js_view', array(
			'add_remove_picture' => __( 'Add/remove picture', 'blackfyre' ),
			'finish_adding_text' => __( 'Finish Adding Images', 'blackfyre' ),
			'add_image' => __( 'Add Image', 'blackfyre' ),
			'add_images' => __( 'Add Images', 'blackfyre' ),
			'settings' => __( 'Settings', 'blackfyre' ),
			'main_button_title' => __( 'Visual Composer', 'blackfyre' ),
			'main_button_title_backend_editor' => __( 'BACKEND EDITOR', 'blackfyre' ),
			'main_button_title_frontend_editor' => __( 'FRONTEND EDITOR', 'blackfyre' ),
			'main_button_title_revert' => __( 'CLASSIC MODE', 'blackfyre' ),
			'please_enter_templates_name' => __( 'Please enter template name', 'blackfyre' ),
			'confirm_deleting_template' => __( 'Confirm deleting "{template_name}" template, press Cancel to leave. This action cannot be undone.', 'blackfyre' ),
			'press_ok_to_delete_section' => __( 'Press OK to delete section, Cancel to leave', 'blackfyre' ),
			'drag_drop_me_in_column' => __( 'Drag and drop me in the column', 'blackfyre' ),
			'press_ok_to_delete_tab' => __( 'Press OK to delete "{tab_name}" tab, Cancel to leave', 'blackfyre' ),
			'slide' => __( 'Slide', 'blackfyre' ),
			'tab' => __( 'Tab', 'blackfyre' ),
			'section' => __( 'Section', 'blackfyre' ),
			'please_enter_new_tab_title' => __( 'Please enter new tab title', 'blackfyre' ),
			'press_ok_delete_section' => __( 'Press OK to delete "{tab_name}" section, Cancel to leave', 'blackfyre' ),
			'section_default_title' => __( 'Section', 'blackfyre' ),
			'please_enter_section_title' => __( 'Please enter new section title', 'blackfyre' ),
			'error_please_try_again' => __( 'Error. Please try again.', 'blackfyre' ),
			'if_close_data_lost' => __( 'If you close this window all shortcode settings will be lost. Close this window?', 'blackfyre' ),
			'header_select_element_type' => __( 'Select element type', 'blackfyre' ),
			'header_media_gallery' => __( 'Media gallery', 'blackfyre' ),
			'header_element_settings' => __( 'Element settings', 'blackfyre' ),
			'add_tab' => __( 'Add tab', 'blackfyre' ),
			'are_you_sure_convert_to_new_version' => __( 'Are you sure you want to convert to new version?', 'blackfyre' ),
			'loading' => __( 'Loading...', 'blackfyre' ),
			// Media editor
			'set_image' => __( 'Set Image', 'blackfyre' ),
			'are_you_sure_reset_css_classes' => __( 'Are you sure that you want to remove all your data?', 'blackfyre' ),
			'loop_frame_title' => __( 'Loop settings' ),
			'enter_custom_layout' => __( 'Custom row layout', 'blackfyre' ),
			'wrong_cells_layout' => __( 'Wrong row layout format! Example: 1/2 + 1/2 or span6 + span6.', 'blackfyre' ),
			'row_background_color' => __( 'Row background color', 'blackfyre' ),
			'row_background_image' => __( 'Row background image', 'blackfyre' ),
			'column_background_color' => __( 'Column background color', 'blackfyre' ),
			'column_background_image' => __( 'Column background image', 'blackfyre' ),
			'guides_on' => __( 'Guides ON', 'blackfyre' ),
			'guides_off' => __( 'Guides OFF', 'blackfyre' ),
			'template_save' => __( 'New template successfully saved!', 'blackfyre' ),
			'template_added' => __( 'Template added to the page.', 'blackfyre' ),
			'template_added_with_id' => __( 'Template added to the page. Template has ID attributes, make sure that they are not used more than once on the same page.', 'blackfyre' ),
			'template_removed' => __( 'Template successfully removed.', 'blackfyre' ),
			'template_is_empty' => __( 'Nothing to save. Template is empty.', 'blackfyre' ),
			'css_updated' => __( 'Page settings updated!', 'blackfyre' ),
			'update_all' => __( 'Update all', 'blackfyre' ),
			'confirm_to_leave' => __( 'The changes you made will be lost if you navigate away from this page.', 'blackfyre' ),
			'inline_element_saved' => __( '%s saved!', 'blackfyre' ),
			'inline_element_deleted' => __( '%s deleted!', 'blackfyre' ),
			'inline_element_cloned' => __( '%s cloned. <a href="#" class="vc_edit-cloned" data-model-id="%s">Edit now?</a>', 'blackfyre' ),
			'gfonts_loading_google_font_failed' => __( 'Loading Google Font failed', 'blackfyre' ),
			'gfonts_loading_google_font' => __( 'Loading Font...', 'blackfyre' ),
			'gfonts_unable_to_load_google_fonts' => __( 'Unable to load Google Fonts', 'blackfyre' ),
			//'gfonts_font_loaded' => __( 'Google Font loaded successfully', 'blackfyre' ),
			'no_title_parenthesis' => sprintf( '(%s)', __( 'no title', 'blackfyre' ) ),
			'error_while_saving_image_filtered' => __( 'Error while applying filter to the image. Check your server and memory settings.', 'blackfyre' ),
		) ) );
	...
	public function registerAdminCss() {
		...
		wp_register_style( 'blackfyre', vc_asset_url( $backend_default_css ), array(
			'isotope-css',
			'animate-css'
	...
	public function pluginActionLinks( $links, $file ) {
		if ( $file == plugin_basename( vc_path_dir( 'APP_DIR', '/js_composer.php' ) ) ) {
			$link = '<a title="' . __( 'Visual Composer Settings', 'blackfyre' ) . '" href="' . esc_url( $this->getSettingsPageLink() ) . '">' . esc_html__( 'Settings', 'blackfyre' ) . '</a>';
