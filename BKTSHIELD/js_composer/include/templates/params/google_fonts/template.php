<div class="vc_row-fluid vc_column">
	<div class="wpb_element_label"><?php _e( 'Font Family', 'blackfyre' ); ?></div>
		...
		<select class="vc_google_fonts_form_field-font_family-select"
			...
			foreach ( $fonts as $font_data ): ?>
				<option value="<?php echo $font_data->font_family . ':' . $font_data->font_styles; ?>"
				        ...
				        class="<?php echo vc_build_safe_css_class( $font_data->font_family ); ?>" <?php echo( strtolower( $values['font_family'] ) == strtolower( $font_data->font_family ) || strtolower( $values['font_family'] ) == strtolower( $font_data->font_family ) . ':' . $font_data->font_styles ? 'selected="selected"' : '' ); ?> ><?php _e( $font_data->font_family, 'blackfyre' ); ?></option>
			<?php endforeach; ?>
		</select>
	</div>
...
<?php if ( isset( $fields['no_font_style'] ) && $fields['no_font_style'] === false || ! isset( $fields['no_font_style'] ) ): ?>
	<div class="vc_row-fluid vc_column">
		<div class="wpb_element_label"><?php _e( 'Font style', 'blackfyre' ); ?></div>
...
<div class="vc_row-fluid vc_column">
	<div class="wpb_element_label"><?php _e( 'Google Fonts preview', 'blackfyre' ); ?>:</div>
	<div class="vc_google_fonts_form_field-preview-container">
		<span><?php _e( 'Grumpy wizards make toxic brew for the evil Queen and Jack.', 'blackfyre' ); ?></span>
	</div>
