...
<div id="vc_templates-editor" class="vc_panel vc_templates-editor" style="display: none;">
	<div class="vc_panel-heading">
		...
		<h3 class="vc_panel-title"><?php _e( 'Templates', 'blackfyre' ) ?></h3>
	</div>
				...
				<div id="vc_tabs-templates" class="vc_panel-tabs">
					...
					<ul class="vc_edit-form-tabs-menu">
						<li class="vc_edit-form-tab-control"><a class="vc_edit-form-link"
						                                        href="#tabs-templates-tabs-1"><?php _e( 'My templates', 'blackfyre' ); ?></a>
						</li>
						<?php if ( $templates_exists ): ?>
							<li class="vc_edit-form-tab-control"><a class="vc_edit-form-link"
							                                        href="#tabs-templates-tabs-2"><?php _e( 'Default templates', 'blackfyre' ); ?></a>
							</li>
						<?php endif; ?>
					</ul>
					<div class="vc_edit-form-tab" id="tabs-templates-tabs-1">
						<div class="vc_col-sm-12 vc_column inside">
							<div
								class="wpb_element_label"><?php _e( 'Save current layout as a template', 'blackfyre' ) ?></div>
							<div class="edit_form_line">
								<input name="padding" class="wpb-textinput vc_title_name" type="text" value=""
								       id="vc_template-name"
								       placeholder="<?php _e( 'Template name', 'blackfyre' ) ?>">
								<button id="vc_template-save"
								        class="vc_btn vc_btn-primary vc_btn-sm"><?php _e( 'Save Template', 'blackfyre' ) ?></button>
							</div>
								<span
									class="vc_description"><?php _e( 'Save layout and reuse it on different sections of this site.', 'blackfyre' ) ?></span>
						</div>
						<div class="vc_col-sm-12 vc_column">
							<div class="wpb_element_label"><?php _e( 'Load Template', 'blackfyre' ) ?></div>
								<span
									class="vc_description"><?php _e( 'Append previosly saved template to the current layout', 'blackfyre' ) ?></span>
					...
					<?php if ( $templates_exists ): ?>
						<div class="vc_edit-form-tab" id="tabs-templates-tabs-2">
							<div class="vc_col-sm-12 vc_column inside">
								...
								<div class="wpb_element_label"><?php _e( 'Load Template', 'blackfyre' ); ?></div>
								<span
									class="description"><?php _e( 'Append default template to the current layout', 'blackfyre' ); ?></span>
