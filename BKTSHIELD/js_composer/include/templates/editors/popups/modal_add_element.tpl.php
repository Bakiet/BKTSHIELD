	...
	<div class="vc_modal-dialog modal-dialog">
		<div class="vc_modal-content">
			<div class="vc_modal-header">
				<a href="#" title="<?php _e( 'Close panel', 'blackfyre' ); ?>" class="vc_close" data-dismiss="modal"
				...
				<input id="vc_elements_name_filter" type="text" name="vc_content_filter" class="vc_elements-list-filter"
				       placeholder="<?php esc_attr_e( 'Search element by title', 'blackfyre' ); ?>"/>

				<h3 class="vc_modal-title"
				    id="vc_add-element-dialog-title"><?php _e( 'Add Element', 'blackfyre' ) ?></h3>
			</div>
			<div class="vc_modal-body wpb-elements-list">
				<ul class="wpb-content-layouts-container" style="position: relative;">
					...
					<li class="vc_modal-add-elements-list-deprecated">
						<div
							class="wpb_element_wrapper"><?php echo vc_message_warning( __( 'Elements within this list are deprecated and are no longer supported in newer versions of Visual Composer.', 'blackfyre' ) ); ?></div>
					</li>
