...
<div id="vc_templates-panel" class="vc_panel vc_templates-panel" style="display: none;">
	<div class="vc_panel-heading"><a
			title="<?php _e( 'Close panel', 'blackfyre' ); ?>" href="javascript:;" class="vc_close"
			data-dismiss="panel"
			aria-hidden="true"><i class="vc_icon"></i></a><a
			title="<?php _e( 'Hide panel', 'blackfyre' ); ?>" href="javascript:;" class="vc_transparent"
			data-transparent="panel"
			aria-hidden="true"><i class="vc_icon"></i></a>

		<h3
			class="vc_panel-title"><?php _e( 'Templates', 'blackfyre' ); ?></h3>
	</div>
	<?php
