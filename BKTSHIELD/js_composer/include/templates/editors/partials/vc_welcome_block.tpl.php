<div id="vc_no-content-helper" class="vc_welcome">
	...
	<h5><?php _e( 'Welcome to Blank Page, You Have No Content Yet!', 'blackfyre' ) ?></h5>

	<h3><?php _e( ' Add Some Content or Use Predefined Layouts...', 'blackfyre' ) ?></h3>

	<div class="vc_buttons">
		<a id="vc_not-empty-add-element" class="vc_add-element-not-empty-button vc_add-element-action"
		   title="<?php _e( 'Add Element', 'blackfyre' ) ?>"></a><a id="vc_no-content-add-element"
		                                                              class="vc_add-element-button vc_add-element-action vc_btn vc_btn-grace vc_btn-md vc_btn_3d"
		                                                              href="#"
		                                                              title="<?php _e( 'Add Element', 'blackfyre' ) ?>"><?php _e( 'Add Element', 'blackfyre' ) ?></a><?php
		...
		?><a
			...
			href="#"
			title="<?php _e( 'Add Text Block', 'blackfyre' ) ?>"><?php _e( 'Add Text Block', 'blackfyre' ) ?></a><?php endif; ?>
	</div>
	<?php
			...
			<div class="wpb_row vc_row-fluid">
				...
				<?php if ( $templates_total_count != count( $templates ) ): ?>
					<div class="vc_default-templates-more-layouts"><a
							...
							id="vc_templates-more-layouts"><?php echo __( 'More Layouts', 'blackfyre' ); ?></a></div>
				<?php endif; ?>
			</div>
		</div>
	<?php endif; ?>
