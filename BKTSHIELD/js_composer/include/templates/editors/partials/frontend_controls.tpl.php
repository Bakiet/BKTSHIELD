<script type="text/html" id="vc_controls-template-default">
	<div
		...
		<div class="vc_controls-cc"><a class="vc_control-btn vc_element-name vc_element-move"><span
					...
					title="<?php printf( __( 'Drag to move %s', 'blackfyre' ), '{{ name }}' ) ?>">{{ name }}</span></a><a
	...
	<div class="vc_controls-container">
		<div class="vc_controls-out-tl">
			<div class="vc_element element-{{ tag }}"><a class="vc_control-btn vc_element-name vc_element-move"
			                                             title="<?php printf( __( 'Drag to move %s', 'blackfyre' ), '{{ name }}' ) ?>"><span
		...
		<div class="vc_controls-bc"><a class="vc_control-btn vc_control-btn-append" href="#"
		                               title="<?php printf( __( 'Append to %s', 'blackfyre' ), '{{ name }}' ) ?>"><span
					class="vc_btn-content"><span class="icon"></span></span></a></div>
	...
	<div class="vc_controls-column">
		<div class="vc_controls-out-tl">
			<div class="vc_parent parent-{{ parent_tag }}"><a
					...
					title="<?php printf( __( 'Drag to move %s', 'blackfyre' ), '{{ parent_name }}' ) ?>"><span
						class="vc_btn-content">{{ parent_name }}</span></a><span class="advanced"><a
						class="vc_control-btn vc_control-btn-edit vc_edit" href="#"
						title="<?php printf( __( 'Edit %s', 'blackfyre' ), '{{ parent_name }}' ) ?>"><span
							class="vc_btn-content"><span class="icon"></span></span></a><a
						class="vc_control-btn vc_control-btn-prepend vc_edit" href="#"
						title="<?php printf( __( 'Prepend to %s', 'blackfyre' ), '{{ parent_name }}' ) ?>"><span
							class="vc_btn-content"><span class="icon"></span></span></a><a
						class="vc_control-btn vc_control-btn-clone" href="#"
						title="<?php printf( __( 'Clone %s', 'blackfyre' ), '{{ parent_name }}' ) ?>"><span
							class="vc_btn-content"><span class="icon"></span></span></a><a
						class="vc_control-btn vc_control-btn-delete" href="#"
						title="<?php printf( __( 'Delete %s', 'blackfyre' ), '{{ parent_name }}' ) ?>"><span
							class="vc_btn-content"><span class="icon"></span></span></a></span><a
					class="vc_control-btn vc_control-btn-switcher"
					title="<?php printf( __( 'Show %s controls', 'blackfyre' ), '{{ parent_name }}' ) ?>"><span
						class="vc_btn-content"><span class="icon"></span></span></a></div>
			<div class="vc_element element-{{ tag }} vc_active"><a
					...
					title="<?php printf( __( 'Drag to move %s', 'blackfyre' ), '{{ name }}' ) ?>"><span
						...
						title="<?php printf( __( 'Prepend to %s', 'blackfyre' ), '{{ name }}' ) ?>"><span
							class="vc_btn-content"><span class="icon"></span></span></a></span><a
					class="vc_control-btn vc_control-btn-switcher"
					title="<?php printf( __( 'Show %s controls', 'blackfyre' ), '{{ name }}' ) ?>"><span
						class="vc_btn-content"><span class="icon"></span></span></a></div>
		</div>
		<div class="vc_controls-bc"><a class="vc_control-btn vc_control-btn-append" href="#"
		                               title="<?php printf( __( 'Append to %s', 'blackfyre' ), '{{ name }}' ) ?>"><span
		...
		<div class="vc_controls-out-tl">
			<div class="vc_parent parent-{{ parent_tag }}"><a
					...
					title="<?php printf( __( 'Drag to move %s', 'blackfyre' ), '{{ parent_name }}' ) ?>"><span
						...
						title="<?php printf( __( 'Change layout', 'blackfyre' ) ) ?>"><span
							class="vc_btn-content"><span class="icon"></span></span></a><a
						class="vc_control-btn vc_control-btn-prepend vc_edit" href="#"
						title="<?php printf( __( 'Add new %s', 'blackfyre' ), '{{ name }}' ) ?>"><span
							class="vc_btn-content"><span class="icon"></span></span></a><a
						class="vc_control-btn vc_control-btn-clone" href="#"
						title="<?php printf( __( 'Clone %s', 'blackfyre' ), '{{ parent_name }}' ) ?>"><span
							class="vc_btn-content"><span class="icon"></span></span></a><a
...
<script type="text/html" id="vc_controls-template-vc_tta_section">
	<div class="vc_controls-container">
		<div class="vc_controls-out-tr">
			<div class="vc_parent parent-{{ parent_tag }}"><a
					...
					title="<?php printf( __( 'Drag to move %s', 'blackfyre' ), '{{ parent_name }}' ) ?>"><span
						class="vc_btn-content">{{ parent_name }}</span></a><span class="vc_advanced"><a
						class="vc_control-btn vc_control-btn-edit vc_edit" href="#"
						title="<?php printf( __( 'Edit %s', 'blackfyre' ), '{{ parent_name }}' ) ?>" data-vc-control="parent.edit"><span
							class="vc_btn-content"><span class="icon"></span></span></a><a
						class="vc_control-btn vc_control-btn-prepend vc_edit" href="#"
						title="<?php printf( __( 'Add new %s', 'blackfyre' ), '{{ name }}' ) ?>" data-vc-control="parent.append"><span
							class="vc_btn-content"><span class="icon"></span></span></a><a
						class="vc_control-btn vc_control-btn-clone" href="#"
						title="<?php printf( __( 'Clone %s', 'blackfyre' ), '{{ parent_name }}' ) ?>" data-vc-control="parent.clone"><span
							class="vc_btn-content"><span class="icon"></span></span></a><a
						class="vc_control-btn vc_control-btn-delete" href="#"
						title="<?php printf( __( 'Delete %s', 'blackfyre' ), '{{ parent_name }}' ) ?>" data-vc-control="parent.destroy"><span
							class="vc_btn-content"><span class="icon"></span></span></a></span><a
					class="vc_control-btn vc_control-btn-switcher"
					title="<?php printf( __( 'Show %s controls', 'blackfyre' ), '{{ parent_name }}' ) ?>"><span
						class="vc_btn-content"><span class="icon"></span></span></a></div>
			<div class="vc_element element-{{ tag }} vc_active"><a
					...
					title="<?php printf( __( 'Drag to move %s', 'blackfyre' ), '{{ name }}' ) ?>"><span
						class="vc_btn-content">{{ name }}</span></a><span class="vc_advanced"><a
						class="vc_control-btn vc_control-btn-edit" href="#"
						title="<?php printf( __( 'Edit %s', 'blackfyre' ), '{{ name }}' ) ?>" data-vc-control="edit"><span
							class="vc_btn-content"><span class="icon"></span></span></a><a
						class="vc_control-btn vc_control-btn-prepend" href="#"
						title="<?php printf( __( 'Prepend to %s', 'blackfyre' ), '{{ name }}' ) ?>" data-vc-control="prepend"><span
							class="vc_btn-content"><span class="icon"></span></span></a><a
						class="vc_control-btn vc_control-btn-clone" href="#"
						title="<?php printf( __( 'Clone %s', 'blackfyre' ), '{{ name }}' ) ?>" data-vc-control="clone"><span
							class="vc_btn-content"><span class="icon"></span></span></a><a
						class="vc_control-btn vc_control-btn-delete" href="#"
						title="<?php printf( __( 'Delete %s', 'blackfyre' ), '{{ name }}' ) ?>" data-vc-control="destroy"><span
							class="vc_btn-content"><span class="icon"></span></span></a></span><a
					class="vc_control-btn vc_control-btn-switcher"
					title="<?php printf( __( 'Show %s controls', 'blackfyre' ), '{{ name }}' ) ?>"><span
						class="vc_btn-content"><span class="icon"></span></span></a></div>
		...
		<div class="vc_controls-bc"><a class="vc_control-btn vc_control-btn-append" href="#"
		                               title="<?php printf( __( 'Append to %s', 'blackfyre' ), '{{ name }}' ) ?>"  data-vc-control="append"><span
					class="vc_btn-content"><span class="icon"></span></span></a></div>
