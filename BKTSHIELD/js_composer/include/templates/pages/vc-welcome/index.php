<div class="wrap vc-page-welcome about-wrap">
	<h1><?php echo sprintf( __( 'Welcome to Visual Composer %s', 'blackfyre' ), preg_replace( '/^(\d+)(\.\d+)?(\.\d)?/', '$1$2', WPB_VC_VERSION ) ) ?></h1>

	<div class="about-text">
		<?php _e( 'Congratulations! You are about to use most powerful time saver for WordPress ever - page builder plugin with Frontend and Backend editors by WPBakery.', 'blackfyre' ) ?>
	</div>
	<div class="wp-badge vc-page-logo">
		<?php echo sprintf( __( 'Version %s', 'blackfyre' ), WPB_VC_VERSION ) ?>
	</div>
	<p class="vc-page-actions">
		<a href="<?php echo esc_attr( admin_url( 'admin.php?page=vc-general' ) ) ?>"
		   class="button button-primary"><?php _e( 'Settings', 'blackfyre' ) ?></a>
