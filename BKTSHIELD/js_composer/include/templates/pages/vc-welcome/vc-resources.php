<div class="vc_resources-tab changelog">
	<div class="feature-section col two-col">
		<div>
			<h3><?php _e( 'Resources', 'blackfyre' ); ?></h3>

			<p><?php _e( 'There are several resources available to Visual Composer users to help you to get around plugin:', 'blackfyre' ); ?></p>
			<ul>
				<li>
