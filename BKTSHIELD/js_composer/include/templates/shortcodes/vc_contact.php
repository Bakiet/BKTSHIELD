...
<div id="buddypress" class="<?php echo $css_class; if(!empty($el_class)) echo $el_class; ?>">
    <div class="wpb_wrapper">
        <div class="title-wrapper">
            <h3 class="widget-title"><i class="fa fa-envelope"></i> <?php if(!empty($el_contact_title)) echo $el_contact_title; ?></h3>
            <div class="clear"></div>
        </div>
