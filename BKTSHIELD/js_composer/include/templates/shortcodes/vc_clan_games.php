...
<div class="<?php echo $css_class; if(!empty($el_class)) echo $el_class; ?> block">
    <div class="wpb_wrapper">
        <div class="title-wrapper">
            <h3 class="widget-title"><i class="fa fa-gamepad"></i> <?php if(!empty($el_games_title)){ echo $el_games_title;}else{ _e('Games', 'blackfyre'); } ?></h3>
            <div class="clear"></div>
        </div>
        <div class="wcontainer">
	        ...
	        foreach ( $el_games as $game ) {
				...
				<li> <img alt="img" src="<?php echo blackfyre_return_game_image($g[0]->id); ?>" /> <strong><?php echo $g[0]->title; ?> </strong></li>
				<?php
