...
<div class="<?php echo $css_class; if(!empty($el_class)) echo $el_class; ?>">
    <div class="wpb_wrapper">
        <div class="title-wrapper">
            <h3 class="widget-title"><i class="fa fa-newspaper-o"></i> <?php if(!empty($el_news_horizontal_title)) echo $el_news_horizontal_title; ?></h3>
            <div class="clear"></div>
        </div>
        <?php
                    // Categories
        ...
        <div class="wcontainer">
          <ul class="newsbv">
               <?php while ( $posts->have_posts() ) : $posts->the_post(); ?>
                ...
                <?php global $more; $more = 1; echo skywarrior_limit_words(get_the_content(),35); echo '[...]'; ?>
                <?php endif; ?>
                <div class="clear"></div>
                </li>
