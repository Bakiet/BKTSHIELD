...
<div class="<?php echo $css_class; if(!empty($el_class)) echo $el_class; ?>">
    <div class="wpb_wrapper">
        <div class="title-wrapper">
            <h3 class="widget-title"><i class="fa fa-newspaper-o"></i> <?php if(!empty($el_blog_title)) echo $el_blog_title; ?></h3>
            <div class="clear"></div>
        </div>
        ...
        <div class="blog-twrapper">
         ...
         <div class="blog-info">
                    ...
                    <div class="post-pinfo">
                       ...
                       <?php } ?>
                        <?php $posttags = get_the_tags();if ($posttags) {?>  <span class="fa fa-tags"></span>  <?php foreach($posttags as $tag) { ?>  <a href="<?php echo get_tag_link($tag->term_id); ?>"> <?php echo $tag->name . ', '; ?> </a><?php }}?>
                    </div><!-- post-pinfo -->
