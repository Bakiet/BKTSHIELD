...
<div id="buddypress" class="<?php echo $css_class; if(!empty($el_class)) echo $el_class; ?> clans-block">
    <div class="wpb_wrapper" id="members">
        <div class="title-wrapper">
            <h3 class="widget-title"><i class="fa fa-group"></i> <?php if(!empty($el_clans_title)) echo $el_clans_title; ?></h3>
            <div class="clear"></div>
        </div>
       <?php
   ...
   <?php while ( $the_query->have_posts() ) { $the_query->the_post();  ?>
        <li>
                    ...
                    <div class="item-avatar">
                       <a href="<?php echo get_permalink($post->ID); ?> ">
                         <?php $img = get_post_meta( $post->ID, 'clan_photo', true );
                               ...
                               ?>
                        <img alt="img" src="<?php echo $image; ?>" class="avatar" >
                       </a>
                    </div>
            ...
            <?php if($members == 1){ echo $members; ?>&nbsp;<?php _e('Member','blackfyre'); }else{ echo $members; ?>&nbsp;<?php _e('Members','blackfyre'); } ?></span></div>
                        </div>
                    </div>
                    <div class="clear"></div>
                </div>
