		...
		$p['vc_grid_item'] = array(
			...
			'messages' => array(
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s </p>',
							__( 'Start Here!', 'blackfyre' ),
							__( 'Start easy - use predefined template as a starting point and modify it.', 'blackfyre' )
						),
				...
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s </p>',
							__( 'Use Animations', 'blackfyre' ),
							__( 'Select animation preset for grid element. "Hover" state will be added next to the "Normal" state tab.', 'blackfyre' )
						),
				...
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s </p>',
							__( 'Style Design Options', 'blackfyre' ),
							__( 'Edit "Normal" state to set "Featured image" as a background, control zone sizing proportions and other design options (Height mode: Select "Original" to scale image without cropping).', 'blackfyre' )
						),
				...
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s </p>',
								__( 'Extend Element', 'blackfyre' ),
								__( 'Additional content zone can be added to grid element edges (Note: This zone can not be animated).', 'blackfyre' )
				...
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> %s',
							__( 'Watch Video Tutorial', 'blackfyre' ),
