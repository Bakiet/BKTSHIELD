		...
		$p['vc_pointers_backend_editor'] = array(
			...
			'messages' => array(
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s </p>',
							__( 'Welcome to Visual Composer', 'blackfyre' ),
							__( 'Choose Backend or Frontend editor.', 'blackfyre' )
						),
						'position' => array(
							'edge' => 'left',
							'align' => 'center'
				...
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s </p>',
							__( 'Add Elements', 'blackfyre' ),
							__( 'Add new element or start with a template.', 'blackfyre' )
						),
						'position' => array(
							'edge' => 'left',
							'align' => 'center'
				...
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s </p>',
							__( 'Rows and Columns', 'blackfyre' ),
							__( 'This is a row container. Divide it into columns and style it. You can add elements into columns.', 'blackfyre' )
						),
						'position' => array(
							'edge' => 'left',
							'align' => 'center'
				...
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s <br/><br/> %s</p>',
							__( 'Control Elements', 'blackfyre' ),
							__( 'You can edit your element at any time and drag it around your layout.', 'blackfyre' ),
							sprintf( __( 'P.S. Learn more at our <a href="%s" target="_blank">Knowledge Base</a>.', 'blackfyre' )
		...
		$p[ 'showEvent_pointers_backend_editor' ] = array(
			...
			'messages' => array(
				array(
					...
					'options' => array(
						'content'  => sprintf( '<h3> %s </h3> <p> %s </p>',
							__( 'Ha ha this is third', 'blackfyre' ),
							__( '3 Ps use predefined template as a starting point and modify it.', 'blackfyre' )
						),
				...
				array(
					...
					'options' => array(
						'content'  => sprintf( '<h3> %s </h3> <p> %s </p>',
							__( 'Ha ha this is the last one!', 'blackfyre' ),
							__( '4 Ps use predefined template as a starting point and modify it.', 'blackfyre' )
						),
						'position' => array( 'edge' => 'left', 'align' => 'center' ),
						'buttons' => 'vcPointersEditorsTourEvents',
						'closeEvent' => 'click #poststuff',
