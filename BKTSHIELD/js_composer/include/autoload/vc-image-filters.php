...
function vc_get_filters() {
	return array(
		'antique' => __( 'Antique', 'blackfyre' ),
		'blackwhite' => __( 'Black & White', 'blackfyre' ),
		'boost' => __( 'Boost', 'blackfyre' ),
		'concentrate' => __( 'Concentrate', 'blackfyre' ),
		'country' => __( 'Country', 'blackfyre' ),
		'darken' => __( 'Darken', 'blackfyre' ),
		'dream' => __( 'Dream', 'blackfyre' ),
		'everglow' => __( 'Everglow', 'blackfyre' ),
		'forest' => __( 'Forest', 'blackfyre' ),
		'freshblue' => __( 'Fresh Blue', 'blackfyre' ),
		'frozen' => __( 'Frozen', 'blackfyre' ),
		'hermajesty' => __( 'Her Majesty', 'blackfyre' ),
		'light' => __( 'Light', 'blackfyre' ),
		'orangepeel' => __( 'Orange Peel', 'blackfyre' ),
		'rain' => __( 'Rain', 'blackfyre' ),
		'retro' => __( 'Retro', 'blackfyre' ),
		'sepia' => __( 'Sepia', 'blackfyre' ),
		'summer' => __( 'Summer', 'blackfyre' ),
		'tender' => __( 'Tender', 'blackfyre' ),
		'vintage' => __( 'Vintage', 'blackfyre' ),
		'washed' => __( 'Washed', 'blackfyre' ),
	);
}
...
function vc_attachment_filter_field( $form_fields, $post ) {
	...
	$html_options = '<option value="">' . __( 'None', 'blackfyre' ) . '</option>';
	...
	$form_fields['vc-image-filter'] = array(
		...
		'html' => '
			<div style="display:none">
				<span class="vc-filter-label">' . __( 'Image filter', 'blackfyre' ) . '</span>
...
function vc_attachment_filter_media_meta( $media_meta, $post ) {
	...
	$media_meta .= __( 'Filter:', 'blackfyre' ) . ' ' . $filters[ $filter_name ];
