...
class Vc_Manager {
	 ...
	 * @var array
	 */
	private $editor_default_post_types = array( 'page', 'clan' ); // TODO: move to Vc settings
	/**
	...
	public function pluginsLoaded() {
		...
		load_plugin_textdomain( 'blackfyre', false, $this->path( 'APP_DIR', 'locale' ) );
	}
	...
	public function isNetworkPlugin() {
		...
		return $this->is_network_plugin ? false : false;
	}
	...
	public function assetUrl( $file ) {
		return preg_replace( '/\s/', '%20', get_template_directory_uri().'/js_composer/'.$this->path( 'ASSETS_DIR_NAME', $file ) ); //*************************izmenjeno*****************
	}
}
