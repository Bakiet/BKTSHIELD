...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'description' => __( 'Select tour display style.', 'blackfyre' ),
		),
		array(
			'type' => 'dropdown',
			'param_name' => 'shape',
			...
			'description' => __( 'Select tour shape.', 'blackfyre' ),
		),
		array(
			'type' => 'dropdown',
			'param_name' => 'color',
			'heading' => __( 'Color', 'blackfyre' ),
			'description' => __( 'Select tour color.', 'blackfyre' ),
		...
		array(
			...
			'description' => __( 'Select tour spacing.', 'blackfyre' ),
			'std' => '1'
		),
		array(
			'type' => 'dropdown',
			...
			'description' => __( 'Select tour gap.', 'blackfyre' ),
		),
		array(
			'type' => 'dropdown',
			...
			'description' => __( 'Select tour navigation position.', 'blackfyre' ),
		),
		array(
			'type' => 'dropdown',
			...
			'description' => __( 'Select tour section title alignment.', 'blackfyre' ),
		),
		array(
			'type' => 'dropdown',
			...
			'value' => array(
				__( 'Auto', 'blackfyre' ) => '',
				__( 'Extra large', 'blackfyre' ) => 'xl',
				__( 'Large', 'blackfyre' ) => 'lg',
				__( 'Medium', 'blackfyre' ) => 'md',
				__( 'Small', 'blackfyre' ) => 'sm',
				__( 'Extra small', 'blackfyre' ) => 'xs',
			),
			'heading' => __( 'Navigation width', 'blackfyre' ),
			'description' => __( 'Select tour navigation width.', 'blackfyre' ),
		),
		array(
			'type' => 'dropdown',
			'param_name' => 'autoplay',
			...
			'description' => __( 'Select auto rotate for tour in seconds (Note: disabled by default).', 'blackfyre' ),
		),
		array(
			'type' => 'textfield',
