...
namespace Controllers
{
    ...
    {
        public Usuario ObtenerUsuario(string id, string pass)
        {

            return UsuarioDao.ObtenerUsuario(id,pass);

        }

        public IList<Conectado> ObtenerUsuarioPorMatch(string matchid)
        {
            ControllerResult resultado = new ControllerResult();

            IList<Conectado> Usuario = UsuarioDao.ObtenerUsuarioPorMatch(matchid);
